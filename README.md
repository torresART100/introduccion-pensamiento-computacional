...
En el siguiente recuadro se puede verificar el uso de la función Def en la enumeración exhautiva, aproximación y búsqueda binaria.
...
Puede observar en la siguiente imagen una explicación de los tipos de conceptos.

<br>
<div align="center"> 
  <img src="readme_img/scope.jpg" width="500">
</div>
<br>

Ahora puede verificar ejemplos para cada uno de los casos. También puede encontrar en los archivos el jupyternotebook que corre estos ejemplos, con el nombre de "scope.ipynb":
